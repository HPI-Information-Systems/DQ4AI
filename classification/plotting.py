...
def plot_performances(df, dataset, polluter, scenario, baselines, with_std=False, use_f1=False, save_path=None, show_legend=False):
    ...
    custom_order = ['Majority class baseline', 'Class ratio baseline', 'Decision Tree', 'Logistic Regression',
    ...
    if show_legend:
        # rename legend items
        new_names = ['Majority class baseline', 'Class ratio baseline', 'DT', 'LogR',
