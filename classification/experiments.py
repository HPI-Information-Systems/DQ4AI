...
class MLPClassifier(torch.nn.Module):
    def __init__(self, input_dim, hidden_layer_sizes=(100,), activation='relu', output_dim=2):
        set_random_seed(42)
...
class PytorchMLPExperiment(PytorchClassificationMLPExperiment):
    def __init__(self, df_train, df_test, metadata):
        ...
        model = MLPClassifier(input_dim=input_dim, hidden_layer_sizes=hidden_layer_sizes, activation='relu',
