...
from classification.experiments import LogRegExperiment, KNeighborsExperiment, DecisionTreeExperiment, \
    ...
    MultilayerPerceptron10Experiment, GradientBoostingClassifierExperiment
...
CLASSIFICATION_DATASETS = ['SouthGermanCredit.csv', 'TelcoCustomerChurn.csv', 'cmc.data']
...
def main():
    ...
    #experiments = [MultilayerPerceptron5Experiment, MultilayerPerceptron10Experiment, GradientBoostingClassifierExperiment]
